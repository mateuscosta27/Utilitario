...
class Ui_StringConnection(object):
    def setupUi(self, StringConnection):
        ...
        StringConnection.resize(845, 250)
        StringConnection.setMinimumSize(QSize(845, 250))
        StringConnection.setMaximumSize(QSize(845, 250))
        ...
        self.lb_host = QLabel(self.frame_3)
        self.lb_host.setObjectName(u"lb_host")
        self.lb_host.setGeometry(QRect(10, 20, 51, 31))
        self.le_host = QLineEdit(self.frame_3)
        self.le_host.setObjectName(u"le_host")
        self.le_host.setGeometry(QRect(70, 24, 200, 30))
        self.le_host.setMinimumSize(QSize(0, 30))
        self.le_host.setSizeIncrement(QSize(200, 30))
        self.le_host.setStyleSheet(u"font: 16pt \"Segoe UI\";")
        self.le_user = QLineEdit(self.frame_3)
        self.le_user.setObjectName(u"le_user")
        self.le_user.setGeometry(QRect(367, 24, 200, 30))
        self.le_user.setMinimumSize(QSize(0, 30))
        self.le_user.setSizeIncrement(QSize(200, 30))
        self.le_user.setStyleSheet(u"font: 16pt \"Segoe UI\";")
        self.lb_user = QLabel(self.frame_3)
        self.lb_user.setObjectName(u"lb_user")
        self.lb_user.setGeometry(QRect(301, 20, 51, 31))
        self.lb_localDb = QLabel(self.frame_3)
        self.lb_localDb.setObjectName(u"lb_localDb")
        self.lb_localDb.setGeometry(QRect(10, 80, 161, 41))
        self.le_localDb = QLineEdit(self.frame_3)
        self.le_localDb.setObjectName(u"le_localDb")
        self.le_localDb.setGeometry(QRect(168, 89, 340, 30))
        self.le_localDb.setMinimumSize(QSize(0, 30))
        self.le_localDb.setSizeIncrement(QSize(200, 30))
        self.le_localDb.setStyleSheet(u"font: 16pt \"Segoe UI\";")
        self.btn_localDB = QPushButton(self.frame_3)
        self.btn_localDB.setObjectName(u"btn_localDB")
        self.btn_localDB.setGeometry(QRect(520, 80, 150, 45))
        self.btn_localDB.setMinimumSize(QSize(150, 45))
        self.btn_localDB.setMaximumSize(QSize(150, 45))
        self.btn_localDB.setBaseSize(QSize(0, 0))
        font = QFont()
        font.setFamilies([u"MS Shell Dlg 2"])
        font.setPointSize(11)
        font.setBold(False)
        font.setItalic(False)
        self.btn_localDB.setFont(font)
        self.btn_localDB.setStyleSheet(u"QPushButton{\n"
"	border-style: none;\n"
"	border-width: 2px;\n"
...
"}")
        self.btn_localDB.setInputMethodHints(Qt.ImhNone)
        icon = QIcon()
        icon.addFile(u"./src/icon_folder.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_localDB.setIcon(icon)
        self.btn_localDB.setIconSize(QSize(20, 20))
        self.btn_testConnection = QPushButton(self.frame_3)
        self.btn_testConnection.setObjectName(u"btn_testConnection")
        self.btn_testConnection.setGeometry(QRect(680, 80, 150, 45))
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u"./src/icon_uncheck.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_testConnection.setIcon(icon1)
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u"./src/icon_disconnectDB.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_statusConection.setIcon(icon2)
    ...
    def retranslateUi(self, StringConnection):
        ...
        self.lb_host.setText(QCoreApplication.translate("StringConnection", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700;\">Host:</span></p></body></html>", None))
        self.le_host.setPlaceholderText(QCoreApplication.translate("StringConnection", u"Host do servidor", None))
        self.le_user.setPlaceholderText(QCoreApplication.translate("StringConnection", u"User servidor", None))
        self.lb_user.setText(QCoreApplication.translate("StringConnection", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700;\">User:</span></p></body></html>", None))
        self.lb_localDb.setText(QCoreApplication.translate("StringConnection", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700;\">Local do Banco:</span></p></body></html>", None))
        self.le_localDb.setPlaceholderText(QCoreApplication.translate("StringConnection", u"Local onde ficar\u00e1 o DB", None))
        self.btn_localDB.setText(QCoreApplication.translate("StringConnection", u"Criar Diretorio", None))
